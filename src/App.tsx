  ...
  useEffect(() => {
    if (currentStatus === 'Available' && !incomingCall && !activeCall) {
      const callTimeout = setTimeout(() => {
        setIncomingCall(generateRandomUSANumber());
      }, 3000);
